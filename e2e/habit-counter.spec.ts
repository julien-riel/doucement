...
// Données de test pour habitude compteur (increase)
const counterIncreaseData = {
  schemaVersion: 9,
  habits: [
    {
...
// Données de test pour habitude compteur (decrease)
const counterDecreaseData = {
  schemaVersion: 9,
  habits: [
    {
...
test.describe('Habitude compteur increase', () => {
  ...
  test('affiche les boutons +1/-1 au lieu des boutons de check-in classiques', async ({ page }) => {
