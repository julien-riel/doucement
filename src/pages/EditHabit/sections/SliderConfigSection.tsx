/**
 * SliderConfigSection - Configuration du slider avec mapping emoji
 *
 ...
 * Affichée uniquement quand trackingMode='slider'
 */
export function SliderConfigSection() {
  ...
  const handlePresetSelect = (preset: string) => {
    ...
    if (presetConfig) {
      updateField('sliderConfig', presetConfig)
